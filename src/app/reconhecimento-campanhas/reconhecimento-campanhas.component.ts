...
export interface PeriodicElement {
  ...
  marco_pontuacao_premio: string;
  qual_reconhecimento: string;
  prazo_entrega_resgate: string;
  orientacao_atendimento: string;
  onde_esta_no_beedoo: string;
}

var ELEMENT_DATA: PeriodicElement[] = [];

@Component({
  selector: 'app-reconhecimento-campanhas',
  templateUrl: './reconhecimento-campanhas.component.html',
  styleUrls: ['./reconhecimento-campanhas.component.scss']
})
export class ReconhecimentoCampanhasComponent implements OnInit {

  displayedColumns: string[] = [
  'id',
  'cod_cb_cpf',
  'nome_consultora',
  'marco_pontuacao_premio',
  'qual_reconhecimento',
  'prazo_entrega_resgate',
  ...
  dataSource: any = ELEMENT_DATA;
    ...
    public title: string = "Apuração de Reconhecimento e Campanhas";
    public cod_cb_cpf?: string = "";
  ...
  reconhecimentoCampanhasCodigo() {
      ...
      const registrarTracking = (token: string) => {
        this.painelService.registrarWaveTracking({
          ...
          url: this.router.url,
          usuario: this.user,
          campoPesquisa: 'Código CB ou CPF',
          valorPesquisa: this.cod_cb_cpf,
      ...
      var codigo = parseInt(this.cod_cb_cpf);

      this.painelService.getNatReconhecimentoCampanhas(codigo).subscribe(
        data => {
